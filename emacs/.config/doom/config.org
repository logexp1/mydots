...
(use-package! yaml-mode
  :hook (yaml-ts-mode . (lambda () (spell-fu-mode -1)))
  :config
...
(use-package! yaml-pro
  ...
  (add-hook 'yaml-ts-mode-hook #'yaml-pro-mode 100))
#+end_src
...
** dockerfile
#+begin_src emacs-lisp
(use-package! dockfile-mode
  :config
  (setq! dockerfile-ts-mode-hook dockerfile-ts-mode-hook))
#+end_src
...
(setq-hook! 'dockerfile-ts-mode-hook +format-with 'dockfmt)
