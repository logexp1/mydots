...
어떤 모델이 있는지 보려면, eca-session 에서 이걸 eval 하면 된다.
#+begin_src emacs-lisp :tangle no
(eca--session-models (eca-session))
#+end_src
...
(use-package! eca
  ...
  ((eca-chat-prompt-separator "\n==============================================")
   (eca-chat-custom-model "github-copilot/claude-opus-4.6")
   (eca-chat-custom-behavior "plan"))
  :config
