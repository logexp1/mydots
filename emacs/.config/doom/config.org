...
* font/theme
:PROPERTIES:
:ID:       4b265680-c4bb-4fc3-ae08-105695396442
:END:
** ewal/pywal
...
(setq!
 ...
 doom-variable-pitch-font (font-spec :family "GFS Baskerville")
...
** woman
:PROPERTIES:
:ID:       5eeb6fa8-11e9-46bf-b1aa-829e28e0c181
:END:
#+begin_src emacs-lisp
...
** LSP
:PROPERTIES:
:ID:       56e7c40e-6617-459a-b78a-df44ccbdd058
:END:
...
*** lsp-ui
:PROPERTIES:
:ID:       227479fc-ccd3-47aa-a9e7-87051cffd103
:END:
#+begin_src emacs-lisp
(use-package! lsp-ui
  :after lsp-mode
...
*** dap-mode
:PROPERTIES:
:ID:       ae2937cb-7503-4073-90fc-056490e61a26
:END:
...
(after! dap-mode
  (map! :map dap-mode-map
        :localleader
        :desc "dap-mode"                      "d"   nil
        :desc "dap-debug"                     "dd" #'+debugger/start
        :desc "dap-breakpoint-toggle"         "dt" #'+debugger:toggle-breakpoint
        :desc "dap-breakpoint-condition"      "dc" #'dap-breakpoint-condition
        :desc "dap-next"                      "dn" #'dap-next
        :desc "dap-step-in"                   "di" #'dap-step-in
        :desc "dap-step-out"                  "do" #'dap-step-out
        :desc "dap-disconnect"                "dx" #'dap-disconnect
        :desc "dap-debug-last"                "dl" #'+debugger/start-last))
#+end_src
...
** python
:PROPERTIES:
:ID:       c46e6b44-49d2-4423-91a9-631d3f3e2d77
:END:
#+begin_src emacs-lisp :tangle no
(use-package! python
  :config
...
(use-package pyvenv
  ...
  (projectile-after-switch-project . js/projectile-pyenv-mode-set)
  :config
  (defun js/projectile-pyenv-mode-set ()
...
(map! :map dired-mode-map
       ...
       : "C-d" #'js/dired-dragon-drop
       :n "q" #'js/kill-this-buffer
       ...
       ;; :n "C" #'dired-do-copy
       :n "D" #'dired-do-delete
       :n "o" #'dired-do-shell-command
       ;; :n "Q" #'hydra-dired-quick-sort/body
       :n "zd" #'dired-hide-details-mode)
#+end_src
...
(after! dired
  (map! :map dired-mode-map
        ...
        :desc "source directory" :n "s" '(lambda() (interactive) (find-file "~/OneDrive/src"))
...
** dired-toggle-sudo
:PROPERTIES:
:ID:       dfaaeed4-f39a-4cc7-af29-07a8ed76e5c9
:END:
#+begin_src emacs-lisp
...
** dired-ranger
:PROPERTIES:
:ID:       e4909e97-af7e-4ea0-a0bb-9232cbaee156
:END:
#+begin_src emacs-lisp
