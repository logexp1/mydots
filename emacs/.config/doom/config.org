...
(use-package! tramp
  ...
  ;;              (list (regexp-quote "/ssh:tmp/") "remote-shell" "/bin/bash"))
  ;; (add-to-list 'tramp-connection-properties
  ;;              (list (regexp-quote "/ssh:gpu/") "remote-shell" "/bin/bash"))
  ;; (add-to-list 'tramp-connection-properties
  ;;              (list (regexp-quote "/ssh:gpu8/") "remote-shell" "/bin/bash"))
...
(use-package! eglot
  ...
  (add-to-list 'eglot-server-programs
               ;; just alias pyright-langserver from remote
               ;; `((python-mode python-ts-mode) . ("/home/nsml/.conda/envs/torch/bin/pyright-langserver" "--stdio"))))
